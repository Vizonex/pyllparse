...
from .frontend import source, Frontend, IImplementation, DEFAULT_MAX_TABLE_WIDTH, DEFAULT_MIN_TABLE_SIZE
...
class Compiler:
    ...
    def to_frontend(self,root:source.code.Node,properties:list[source.Property], Impl:Optional[IImplementation] = IImplementation()):
...
class LLParse(source.Builder):
    ...
    def get_compiler(self,
        ...
        maxTableElemWidth:Optional[int] = None ,
        minTableSize:Optional[int] = None):
        return Compiler(self.prefix,headerGuard,debug,maxTableElemWidth if maxTableElemWidth else DEFAULT_MAX_TABLE_WIDTH ,minTableSize if minTableSize else DEFAULT_MIN_TABLE_SIZE)


    def build(self,root:source.code.Node,
        headerGuard:Optional[str] = None, 
        debug:Optional[str] = None,
        maxTableElemWidth:Optional[int] = None ,
