...
class TemplateError(Exception):
    position: str | int
    name: str | None
    def __init__(self, message: str, position: str | int, name: str | None = None) -> None: ...

def get_file_template(name:FileDescriptorOrPath, from_template:Type[_TemplateT]) -> _TemplateT:...
...
class Template:
    ...
    def __init__(self, content: bytes | str, name: str | None = None, namespace: _TemplateNamespace | None = None, stacklevel: Incomplete | None = None, get_template: Incomplete | None = None, default_inherit: Incomplete | None = None, line_offset: int = 0, delimiters: tuple[str | bytes, ...] | None = None) -> None: ...
    @classmethod
    def from_filename(cls, filename: FileDescriptorOrPath, namespace: _TemplateNamespace | None = None, encoding: Incomplete | None = None, default_inherit: Incomplete | None = None, get_template=Callable[[str, Type[_TemplateT], _TemplateT]]) -> Self: ...
...
class HTMLTemplate(Template):
    ...
    @classmethod
    def from_filename(cls, filename: FileDescriptorOrPath, namespace: _HTMLTemplateNamspace | None = None, encoding: Incomplete | None = None, default_inherit: Incomplete | None = None, get_template=Callable[[str, Type[_TemplateT], _TemplateT]]) -> Self: ...
